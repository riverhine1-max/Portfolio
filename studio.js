...
(() => {
  ...
  const VIDEO_SETS = {
    ...
    cinematic: [
      { title: 'GROVEFALL — Trailer V4', label: 'Current cut · AI vision', src: 'Media/grovefall-trailer-v4.mp4?v=4r2', poster: 'Images/grovefall-trailer-v4-poster.webp?v=4r2', description: 'A cinematic journey through snow, a rain-soaked squirrel village, the construct forest, a living tree-city, and the final Iron Spire reveal. AI-generated, not recorded gameplay.' },
