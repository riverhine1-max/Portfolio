...
(() => {
  ...
  const VIDEO_SETS = {
    grovefall: [
      { title: 'GROVEFALL — Trailer V5', label: 'Current cut', src: 'https://d2ol7oe51mr4n9.cloudfront.net/user_3J90Kiwz4QISGac5QlSgYngKSH0/423ea394-332b-456b-bd15-64231304a553.mp4', poster: 'Images/grovefall-trailer-v4-poster.webp?v=5r1', description: 'The polished 93-second cut with corrected glacier-bridge blocking and an active construct fight ending in the crystal strike.' },
      { title: 'GROVEFALL — Trailer V5 · First Pass', label: 'Archive', src: 'https://d2ol7oe51mr4n9.cloudfront.net/user_3J90Kiwz4QISGac5QlSgYngKSH0/09cee475-df52-46a8-9bef-49d41e5e3046.mp4', poster: 'Images/grovefall-trailer-v4-poster.webp?v=4r3', description: 'The first V5 assembly, preserved before the bridge and construct-boss choreography revision.' },
    ...
    cinematic: [
      { title: 'GROVEFALL — Trailer V5', label: 'Current cut · AI vision', src: 'https://d2ol7oe51mr4n9.cloudfront.net/user_3J90Kiwz4QISGac5QlSgYngKSH0/423ea394-332b-456b-bd15-64231304a553.mp4', poster: 'Images/grovefall-trailer-v4-poster.webp?v=5r1', description: 'The polished 93-second cut with corrected glacier-bridge blocking and an active construct fight ending in the crystal strike. AI-generated, not recorded gameplay.' },
      { title: 'GROVEFALL — Trailer V5 · First Pass', label: 'Archive · AI vision', src: 'https://d2ol7oe51mr4n9.cloudfront.net/user_3J90Kiwz4QISGac5QlSgYngKSH0/09cee475-df52-46a8-9bef-49d41e5e3046.mp4', poster: 'Images/grovefall-trailer-v4-poster.webp?v=4r3', description: 'The first V5 assembly, preserved before the bridge and construct-boss choreography revision. AI-generated, not recorded gameplay.' },
